...
- **MA-005** **Validar integração das configurações**: protótipo cobre os 39 campos; resolver divergências de modelo por provedor, valores brutos/efetivos, sensibilidade simples/limiar e operações indisponíveis no Mac antes de portar. Referência: `configuracoes-inventario.md`. Importante, G.
